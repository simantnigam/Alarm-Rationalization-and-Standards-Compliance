...
## Alarm Rationalization and Standards Compliance Copilot
...
## 4. Your Assigned Use Case — Alarm Rationalization and Standards Compliance Copilot

### Business Scenario

Alarm management teams need to identify recurring, stale, nuisance, and suppression-candidate alarms and verify that proposed changes follow alarm philosophy and safety standards.

Build a copilot that combines alarm analytics with policy and standards documents.

### Example Questions

- Identify stale alarms in NorthPlant Unit 1.
- Which alarm codes are the best suppression candidates?
- Show recurring high-severity alarms for Boiler Feed Pump 101 over the last 90 days.
- Calculate the nuisance alarm score for Unit 4.
- Were there alarm flood conditions in Unit 2 last month?
- Which candidates meet the documented suppression criteria?
...
- Alarm philosophy
- Alarm rationalization standards
- Suppression approval criteria
- Site operating policies

### Expected Workflow

1. Interpret scope and time range.
2. Invoke the appropriate MCP analytics tools.
3. Execute controlled KPI flows where needed.
4. Retrieve applicable policy rules through RAG.
5. Rank candidates using API evidence and document criteria.
6. Clearly distinguish measured evidence, policy requirements, and generated recommendations.

### GUI Expectations

- KPI cards
- Trend charts
- Ranked rationalization table
- Policy citations
- Candidate rationale
